...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-64px)] bg-mesh-gradient lg:px-14 sm:px-8 px-4 overflow-hidden">
      {/* Hero Section */}
      <div className="max-w-7xl mx-auto pt-12 sm:pt-20 pb-16">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          >
            <motion.div
              variants={fadeUp}
              className="inline-flex items-center gap-2 bg-blue-50 border border-blue-200/80 text-blue-600 text-xs font-semibold px-3.5 py-1.5 rounded-full mb-6 shadow-sm"
            >
            ...
            <motion.h1
              variants={fadeUp}
              className="font-extrabold font-roboto text-slate-900 text-4xl sm:text-5xl lg:text-6xl tracking-tight leading-[1.15] mb-6"
            >
              Shorten Links.{' '}
            ...
            <motion.p
              variants={fadeUp}
              className="text-slate-600 text-base sm:text-lg mb-8 leading-relaxed max-w-2xl"
            >
            ...
            <motion.div variants={fadeUp} className="flex flex-wrap items-center gap-4">
              <button
                ...
                className="bg-custom-gradient text-white px-7 py-3.5 rounded-xl font-semibold text-sm shadow-brand-md hover:shadow-brand-lg hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200 flex items-center gap-2"
              >
              ...
              <button
                ...
                className="bg-white border border-slate-200/90 text-slate-700 hover:text-blue-600 hover:border-blue-200 px-7 py-3.5 rounded-xl font-semibold text-sm shadow-sm hover:shadow-md transition-all duration-200 flex items-center gap-2"
              >
            ...
            <motion.div
              variants={fadeUp}
              className="flex items-center gap-6 mt-10 pt-8 border-t border-slate-200/70 text-xs font-medium text-slate-500"
            >
          ...
          >
            <div className="w-full max-w-md bg-white/90 backdrop-blur-xl border border-slate-200/80 rounded-3xl p-6 sm:p-7 shadow-2xl shadow-blue-500/10 relative">
              ...
              <div className="mb-4">
                ...
                <div className="p-3 bg-slate-50 rounded-xl border border-slate-200/70 text-xs text-slate-500 font-mono truncate flex items-center gap-2">
                  <span className="text-slate-400">https://</span>
                  <span>example-store.com/products/seasonal-collection?utm_source=spring_sale</span>
                </div>
              </div>
              ...
              <div className="mb-5">
                ...
                <div className="p-3.5 bg-blue-50/70 border border-blue-200/80 rounded-xl flex items-center justify-between">
                  <div className="flex items-center gap-2 min-w-0">
                    ...
                    <span className="text-sm font-semibold text-blue-700 font-mono truncate">
                      linklytics.dev/launch-2026
                    </span>
                  </div>
                  <button
                    onClick={handleCopyDemo}
                    className="p-1.5 rounded-lg bg-white border border-blue-200 text-blue-600 hover:bg-blue-50 transition-colors flex-shrink-0 shadow-xs"
              ...
              <div className="grid grid-cols-2 gap-3 pt-3 border-t border-slate-100">
                <div className="bg-slate-50 rounded-xl p-3 border border-slate-100">
                  ...
                  <span className="text-lg font-bold text-slate-800">1,428 clicks</span>
                </div>
                <div className="bg-slate-50 rounded-xl p-3 border border-slate-100">
                  <div className="flex items-center gap-1.5 text-slate-400 text-xs mb-1">
                    <QrCode className="w-3.5 h-3.5 text-indigo-500" />
                    <span>QR Readiness</span>
                  </div>
      ...
      <div className="max-w-6xl mx-auto py-16 border-t border-slate-200/70">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {steps.map(({ step, title, desc }) => (
            <div
              key={step}
              className="bg-white/70 backdrop-blur-sm border border-slate-200/80 rounded-2xl p-6 shadow-sm relative overflow-hidden"
            >
              <div className="text-4xl font-extrabold text-blue-100 mb-3 font-mono">
                {step}
              </div>
              <h3 className="text-base font-bold text-slate-900 mb-1.5 font-roboto">
                {title}
              </h3>
      ...
      {/* Feature Grid */}
      <div className="max-w-7xl mx-auto py-12 pb-24 border-t border-slate-200/70">
        <div className="text-center max-w-xl mx-auto mb-12">
        ...
        <motion.div
          className="grid lg:grid-cols-4 sm:grid-cols-2 grid-cols-1 gap-6"
          variants={containerStagger}
          initial="hidden"
          whileInView="show"
